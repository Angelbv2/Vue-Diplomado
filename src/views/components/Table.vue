      ...
      <table class="w-full table-auto">
        <thead class="bg-gray-200">
          <tr>
            ...
            <th class="px-4 py-2">Estrato 2</th>
            <th class="px-4 py-2">Estrato 3</th>
            <th class="px-4 py-2">Estrato 4</th>
            <th class="px-4 py-2">Estrato 5</th>
        ...
        <tbody>
          <tr v-for="(fila, index) in datosFiltrados" :key="index">
            ...
            <td class="border px-4 py-2">{{ fila.estrato_2 }}</td>
            <td class="border px-4 py-2">{{ fila.estrato_3 }}</td>
            <td class="border px-4 py-2">{{ fila.estrato_4 }}</td>
            <td class="border px-4 py-2">{{ fila.estrato_5 }}</td>
          </tr>
        </tbody>
      </table>
    </div>
